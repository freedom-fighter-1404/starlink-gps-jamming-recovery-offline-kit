...
## گام ۲: تنظیم رسمی اپ استارلینک (اگر موجود است)
در اپ رسمی Starlink (وقتی به Wi‑Fi محلی دیش وصل هستید)، دنبال این گزینه بگردید:
- **"Use Starlink positioning exclusively"** (محل گزینه ممکن است بسته به نسخه اپ متفاوت باشد)
...
طبق برخی گزارش‌های عمومی، فریمورهای خیلی قدیمی ممکن است تا قبل از آپدیت، به سختی دوباره به شبکه برگردند (منبع: `docs/AUDIT_FA.md`).
